    ...
    <>
      <>
        ...
        <div className="p-0 sm:ml-64 h-screen">
          <div className="h-screen w-full p-4 flex  border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div
              id="detail"
              className={
            ...
            <div className="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800">
              <p className="text-2xl text-gray-400 dark:text-gray-500">+123</p>
            </div>
